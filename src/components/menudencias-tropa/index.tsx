...
export function MenudenciasTropaModule({ operador }: { operador: Operador }) {
  ...
  // Estados de filtros
  const [filtroTropa, setFiltroTropa] = useState('todas')
  ...
  const historialFiltrado = useCallback(() => {
    ...
    if (filtroTropa && filtroTropa !== 'todas') {
              ...
              <div className="flex gap-4 mb-4">
                <div className="flex-1">
                  ...
                  <Select value={filtroTropa} onValueChange={setFiltroTropa}>
                    ...
                    <SelectContent>
                      <SelectItem value="todas">Todas las tropas</SelectItem>
                      {tropas.map((t) => (
                ...
                <div className="flex items-end">
                  <Button 
                    variant="outline" 
                    size="sm"
                    onClick={() => { setFiltroTropa('todas'); setFiltroFecha(''); }}
                  >
                    Limpiar filtros
                  </Button>
                </div>
